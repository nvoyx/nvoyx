	...
	<div class='col box sml90 med80 lge70'>
		<div class='row pad-b20'>
			<div class='col all70 pad-r20'>
				<h1 class='pad0 fs20 c-blue'>Blocks</h1>
			</div>
			<div class='col all30 tar fs14 lh30'>
				<a href='/settings/block/add' class='c-blue pad-b0'>Add</a>
			</div>
		</div>
		<?php $x=0;foreach($NVX_BLOCK->FETCH_ARRAY() as $r){
			$r['bc']=($x%2==0)?'b-lblue':'b-vlblue';?>
			<div class='row pad10 c-white <?=$r['bc'];?>'>
				<div class='col all70 fs14 pad-r20'>
					<p class='pad0 bw'><?=$r['name'];?>&nbsp;&nbsp( <?=$r['id'];?> )</p>
				</div>
				<div class='col all30 fs14 tar'>
					<a href='/settings/block/edit/<?=$r['id'];?>' class='pad-r5 pad-b0 hvr-white'>Edit</a>
					<a onclick="deleteCheck('/settings/block/delete/<?=$r['id'];?>');" class='pad-l5 pad-b0 hvr-white'>Delete</a>
				</div>
			</div>
		<?php $x++;} ?>
	</div>
