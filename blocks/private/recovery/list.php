		...
		if(count($pages[$t]) > 0){
			...
			foreach($pages[$t] as $c){ ?>
				...
				<div class="blank row">
					...
					<a title="edit" href="<?php echo "/settings/recovery/restore/".$t."/".$c["id"];?>"><img class="blank icon fr" src="/settings/resources/files/images/private/group-button-edit.png"></a>
				</div>
