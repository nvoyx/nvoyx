				...
				<div class='col box sml90 med80 lge70'>
					<div class='row pad-b20'>
						<div class='col all70 pad-r20'>
							<h1 class='pad0 fs20 c-blue'>Filelist</h1>
						</div>
					...
					<form method="post">
						...
						<div class='col sml100 med50 lge33 pad-r10 sml-pad-r0 med-pad-r0 pad-b20'>
							<label class='col all100 fs13 c-blue pad-b5'>Maximum Files</label>
							<input class='col all100 fs14 tb' name='total' id='total' type='number' value='<?=$g['total'];?>' placeholder='Maximum Files'>
						</div>
