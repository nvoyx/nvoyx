		...
		if($g["fid"] == $fid){ ?>
			...
			<form method="POST">
				...
				<div class="blank box">
					...
					<div class="blank row">
						<label class="blank fl">Content</label>
						<div class="blank select fr half">
							<?php
							if($g["content"]=="plain"){$flg = " selected";} else {$flg="";} ?>
							<a class='blank mini<?php echo $flg; ?>' onclick="select(this,'content');return false;">Plain</a>
							<?php if($g["content"]=="url"){$flg = " selected";} else {$flg="";} ?>
							<a class='blank mini<?php echo $flg; ?>' onclick="select(this,'content');return false;">URL</a>
						</div>
						<select class="hide" name="content" id="content">
							<?php if($g["content"]=="plain"){$flg = " selected";} else {$flg="";} ?>
							<option<?php echo $flg; ?> value="plain"></option>
							<?php if($g["content"]=="url"){$flg = " selected";} else {$flg="";} ?>
							<option<?php echo $flg; ?> value="url"></option>
						</select>
					</div>
