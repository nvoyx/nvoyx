	...
	<div class='col box sml90 med80 lge70'>
		<div class='row pad-b20'>
			<div class='col all70 pad-r20'>
				<h1 class='pad0 fs20 c-blue'>Types</h1>
			</div>
			<div class='col all30 tar fs14 lh30'>
				<a href='/settings/type/add' class='c-blue pad-b0'>Add</a>
			</div>
		</div>
		<?php $x=0;foreach($NVX_TYPE->FETCH_ARRAY() as $r){
			...
			<div class='row pad10 c-white <?=$r['bc'];?>'>
				...
				<div class='col all30 fs14 tar'>
					<a href='/settings/type/edit/<?=$r['id'];?>' class='pad-r5 pad-b0 hvr-white'>Edit</a>
					<a onclick='deleteCheck("/settings/type/delete/<?=$r['id'];?>");' class='pad-l5 pad-b0 hvr-white'>Delete</a>
				</div>
			</div>
		<?php $x++;} ?>
	</div>
